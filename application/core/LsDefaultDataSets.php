...
class LsDefaultDataSets
{
    ...
    public static function getTemplateConfigurationData()
    {
        ...
        $returnArray[] = [
            ...
            'options'           => '{"ajaxmode":"off", "animatebody":"off", "fixnumauto":"enable", "surveyembedding":"disable","brandlogo":"on","container":"on", "hideprivacyinfo": "off", "brandlogofile":"themes/survey/vanilla/files/logo.png","font":"noto", "showpopups":"1", "showclearall":"off", "questionhelptextposition":"top"}',
        ...
        $returnArray[] = [
            ...
            'files_js'          =>  '{"add":["scripts/theme.js","scripts/ajaxify.js","scripts/custom.js"]}',
            'files_print_css'   => '{"add":["css/print_theme.css"]}',
            'options'           => '{"ajaxmode":"off","fixnumauto":"enable", "surveyembedding":"disable","brandlogo":"on","container":"on","brandlogofile":"themes/survey/bootswatch/files/logo.png", "showpopups":"1", "showclearall":"off", "hideprivacyinfo": "off", "questionhelptextposition":"top"}',
            'cssframework_name' => 'bootstrap',
        ...
        $returnArray[] = [
            ...
            'files_print_css'   => '{"add":["css/print_theme.css"]}',
            'options'           => '{"hideprivacyinfo":"off","showpopups":"1","showclearall":"off","questionhelptextposition":"top","fixnumauto":"enable", "surveyembedding":"disable","backgroundimage":"off","backgroundimagefile":".\/files\/pattern.png",
